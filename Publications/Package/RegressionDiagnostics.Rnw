...
In recent years, generalized linear mixed models (GLMMs) have become a standard tool ecology and evolution \citep{Bolker-Generalizedlinearmixed-2009}. Despite the immense popularity of these methods, fundamental questions remain regarding the inference
