...
#run tweedie model
library(glmmTMB)
tweedieGLMMTMB <- glmmTMB(production ~ Treatment_Num +(1|Genotype),
                     data = df1, family=glmmTMB::tweedie())

simulate(tweedieGLMMTMB)

res <- simulateResiduals(tweedieGLMMTMB, plot = T)
