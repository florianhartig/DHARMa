...
dispersionValues = seq(0,1.2, len = 3)

out = benchmarkOverdispersion(dispersionValues, n = 5)

plot(dispValues, out$positiveDharmaOmnibus, type = "b", xlab = "Overdispersion strength", ylab = "Proportion significant")
lines(dispValues, out$positiveParametric, type = "b", col = "red")
lines(dispValues, out$positiveDharmaNonparametric, type = "b", col = "darkgreen")
