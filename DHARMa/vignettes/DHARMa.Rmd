...
To show this, let's look at the dispersion test for the same model, once ungrouped (left), and grouped according the variable group which was in the data (right).
