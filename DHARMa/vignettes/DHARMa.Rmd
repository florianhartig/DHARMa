...
refit = F, integerResponse = NULL


```{r}
simulationOutput <- simulateResiduals(fittedModel = fittedModel, n = 250, use.u = F)
plotSimulatedResiduals(simulationOutput = simulationOutput)
```
...
Simulations show that this test is considerably less powerfull for specific problems (overdispersion, etc.) than specific (in particular parametric tests). On the other hand, the parametric tests
