...
1.  *default: the simulation0-based response variance test* is a non-parametric test that compares the variance of the observed response variable to the variances of the simulated response variable (default).
