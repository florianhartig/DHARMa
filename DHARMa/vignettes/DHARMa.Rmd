...
knitr::opts_chunk$set(fig.width=8, fig.height=5, warning=FALSE, message=FALSE, cache = T)
```
...
Just for completeness - the second model is the overdispersed model. Don't get too excited if you got it right. Likely, you were simply lucky. Misspecifications in GL(M)Ms cannot reliably be diagnosed with standard residual plots. 
...
So far, we have seen plots for a perfectly specified model. For a correctly specified model, one would expect
