...
The function creates 250 new datasets by simulating from the fitted model, calcualtes the cummulative distribution of simulated values for each observed value, and returns the quantile value that corresponds to the observed value. This is visualized in the following figure 

![Calculations of residuals](../util/figures/ECDFmotivation.png)
