...
#' @param rotation optional rotation of the residual space to remove residual autocorrelation. See details, section *residual auto-correlation* for an extended explanation, and [getQuantile] for syntax. 
#'
